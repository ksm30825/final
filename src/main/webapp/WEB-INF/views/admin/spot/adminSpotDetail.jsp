			...
			<section class="section">
				...
				<div class="field is-horizontal">
					<div class="field-body">
						...
						<div class="field">
					      ...
					      <p class="control">
					        <span class="select is-fullwidth readonlyBg">
					            <select>
					              <option>국가명</option>
				...
				<div class="field is-horizontal">
					<div class="field-body">
						...
						<div class="field">
					    	...
					    	<p class="control">
					          <input class="input readonlyBg" type="text" placeholder="Text input">
					        </p>
					    </div> <!-- end ko name -->
				...
				<div class="field is-horizontal">
					<div class="field-body">
						<div class="field">
							...
							<p class="control">
					          <textarea class="textarea readonlyBg" placeholder="Textarea"></textarea>
					        </p>
						</div>
					</div> <!-- end field-body -->
				...
				<div class="field is-horizontal">
					<div class="field-body">
						...
						<div class="buttons"  style="justify-content:flex-end; display: none;">
				...
				<div class="field is-horizontal">
					<div class="field-body"  style="justify-content:flex-end;">
						<div class="buttons">
							<a class="button is-success is-outlined" style="width:150px;" href="selectAllSpotAdmin.sp"> 돌아가기 </a>
							<a class="button is-danger is-outlined" style="width:150px;" href="#"> 삭제하기 </a>
							<a class="button is-info is-outlined" style="width:150px;" href="#"> 정보수정하기 </a>
						</div>
					</div> <!-- end field-body -->
				</div> <!-- end btn area -->
